...
// configuration step. It creates a namespace called `cmake_test`. You can modify
...
{
  try {
    CLI::App app{ fmt::format("{} version {}", cmake_test::cmake::project_name, cmake_test::cmake::project_version) };
    ...
    if (show_version) {
      fmt::print("{}\n", cmake_test::cmake::project_version);
      return EXIT_SUCCESS;
    }
